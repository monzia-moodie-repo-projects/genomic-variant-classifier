...
# Config: r12only. If the baseline changes, RE-GENERATE (do not hand-patch) to avoid drift.
# launch_run17_r12only.sh -- Run 17 R12-only ablation (FinnGen R13 excluded; generated from baseline).
#
...
#   - OUTDIR pinned to outputs/run17_r12only/full.
...
DATA="$REPO/data"
OUTDIR="$REPO/outputs/run17_r12only/full"
LOG=/workspace/run17_r12only_master.log
