#!/usr/bin/env python3
# =============================================================================
# run17_observability.py
# =============================================================================
# Purpose:  Maximum-information extractor for Run 17. Runs on the Vast.ai VM
...
# Created:  2026-06-28
# Target:   genomic-variant-classifier, Run 17 (commit set at launch)
#
...
#
# Usage on VM:
#   python3 /workspace/genomic-variant-classifier/scripts/run17_observability.py \
#       --outputs-dir /workspace/genomic-variant-classifier/outputs/run9_fresh \
#       --log /workspace/run11_master.log \
#       --report-dir /workspace/run17_report \
...
def write_markdown_report(report: dict[str, Any], path: Path) -> None:
    lines: list[str] = []
    lines.append(f"# Run 17 Observability Report")
...
def main():
    ...
    json_path = report_dir / "run17_observability.json"
    md_path = report_dir / "run17_observability.md"
