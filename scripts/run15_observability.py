#!/usr/bin/env python3
# =============================================================================
# run15_observability.py
# =============================================================================
# Purpose:  Maximum-information extractor for Run 15. Runs on the Vast.ai VM
...
#
# Usage on VM:
#   python3 /workspace/genomic-variant-classifier/scripts/run15_observability.py \
#       --outputs-dir /workspace/genomic-variant-classifier/outputs/run9_fresh \
#       --log /workspace/run11_master.log \
#       --report-dir /workspace/run15_report \
...
def write_markdown_report(report: dict[str, Any], path: Path) -> None:
    lines: list[str] = []
    lines.append(f"# Run 15 Observability Report")
...
def main():
    ...
    json_path = report_dir / "run15_observability.json"
    md_path = report_dir / "run15_observability.md"
